...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.Api.Models.ConversationInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ChatApp.Api.Models.LiveLocationShare", b =>
                {
            ...
            modelBuilder.Entity("ChatApp.Api.Models.LiveStreamSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ChatApp.Api.Models.MessageReaction", b =>
                {
                    b.Property<Guid>("MessageId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ChatApp.Api.Models.MessageReceipt", b =>
                {
                    b.Property<Guid>("MessageId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ChatApp.Api.Models.MessageVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ChatApp.Api.Models.UserBlock", b =>
                {
            ...
            modelBuilder.Entity("ChatApp.Api.Models.ChatMessage", b =>
                {
                    ...
                    b.HasOne("ChatApp.Api.Models.ChatMessage", "ReplyToMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatApp.Api.Models.Conversation", b =>
                {
                    b.HasOne("ChatApp.Api.Models.ChatUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ChatApp.Api.Models.ChatMessage", "LastMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatApp.Api.Models.ConversationInvitation", b =>
                {
                    ...
                    b.HasOne("ChatApp.Api.Models.ChatUser", "InvitedByUser")
                        .WithMany()
                        .HasForeignKey("InvitedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ChatApp.Api.Models.ChatUser", "InvitedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatApp.Api.Models.ConversationMember", b =>
                {
                    ...
                    b.HasOne("ChatApp.Api.Models.ChatMessage", "LastReadMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatApp.Api.Models.DirectConversation", b =>
                {
                    b.HasOne("ChatApp.Api.Models.Conversation", "Conversation")
                        .WithOne()
                        .HasForeignKey("ChatApp.Api.Models.DirectConversation", "ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ChatApp.Api.Models.ChatUser", "UserHigh")
                        .WithMany()
                        .HasForeignKey("UserHighId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ChatApp.Api.Models.ChatUser", "UserLow")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatApp.Api.Models.LiveLocationShare", b =>
                {
                    ...
                    b.HasOne("ChatApp.Api.Models.ChatMessage", "Message")
                        ...
                        .HasForeignKey("ChatApp.Api.Models.LiveLocationShare", "MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ChatApp.Api.Models.LiveStreamSession", b =>
                {
                    ...
                    b.HasOne("ChatApp.Api.Models.ChatUser", "HostUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatApp.Api.Models.MessageVersion", b =>
                {
                    b.HasOne("ChatApp.Api.Models.ChatUser", "Editor")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatApp.Api.Models.UserBlock", b =>
                {
                    b.HasOne("ChatApp.Api.Models.ChatUser", "BlockedUser")
                        .WithMany()
                        .HasForeignKey("BlockedUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ChatApp.Api.Models.ChatUser", "BlockerUser")
                        .WithMany()
